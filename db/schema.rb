...
ActiveRecord::Schema.define(version: 20150812165258) do
  ...
  add_index "task_assignments", ["task_id", "assignor_id", "assignee_id"], name: "my_task_assignment", unique: true, using: :btree
